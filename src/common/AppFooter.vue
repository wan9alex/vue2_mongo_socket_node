<template>
  <div class="foot-btn" >
    <ul>
      <router-link tag="li" to="/home" class="home" active-class="home2"><a href="javascript:;" ></a></router-link>
      <router-link tag="li" to="/bbs" class="write" active-class="write2"><a href="javascript:;" ></a></router-link>
      <router-link @click.native="xxx" tag="li" to="/user" class="my" active-class="my2"><a href="javascript:;" ></a></router-link>
