<template>
  <div class="content">
    ...
    <div class="footbox">
      <!-- <input type="button" @click="CHECK_USER({username:username,password:password})" value="登 录" class="login-btn"/> -->
      <input type="button" @click="login" value="登 录" class="login-btn"/>
